...
<div class="col-md-9 left-col pull-right">
    ...
    <Modal :show.sync="showQrcode" class="text-center">
        ...
        <div>
            <p class="text-md">如果你想学习更多的知识，binblogs.cn 是个不错的开始</p>
            <div class="payment-qrcode inline-block">
                <h5>扫一扫打开 binblogs.com</h5>
                <p>
                    <qrcode-vue value="https://www.binblogs.cn" :size="160"></qrcode-vue>
                </p>
            </div>
        </div>
        <div slot="footer">
        ...
        like(e) {
            ...
            if (!this.auth) {
                ...
                if (active) {
                    ...
                    this.likeClass = 'active onimated rubberBard'
